                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="w-full">
                            <label class="flex flex-col w-full">
                                <p class="text-[#111814] dark:text-gray-200 text-base font-medium leading-normal pb-2">Kategori Lainnya</p>
                                <div class="relative">
                                    <select id="category_select" :value="selectedCategory" @change="selectDropdown"
                                        ...
                                        <option value="">Pilih kategori lain jika tidak ada di atas...</option>
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <label class="flex flex-col flex-1">
                                ...
                                <div class="relative flex items-center">
                                    ...
                                    <input name="amount" required type="number" step="0.01" value="{{ $transaction->amount }}"
                                        class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111814] dark:text-gray-100 focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#dbe6e0] dark:border-[#2a4538] bg-white dark:bg-[#1a2e24] h-14 placeholder:text-[#618975] pl-12 pr-4 text-xl font-bold leading-normal transition-shadow" placeholder="0" />
                                </div>
                            ...
                            <label class="flex flex-col md:w-1/3">
                                <p class="text-[#111814] dark:text-gray-200 text-base font-medium leading-normal pb-2">
                                    Tanggal</p>
                                <div class="relative">
                                    <input name="date" required type="date" value="{{ old('date', $transaction->date->format('Y-m-d')) }}"
                        ...
                        <div class="w-full">
                            <label class="flex flex-col w-full">
                                ...
                                <textarea name="note"
                                    ...
                                    placeholder="Tulis detail pengeluaran...">{{ old('note', $transaction->note) }}</textarea>
                            </label>
